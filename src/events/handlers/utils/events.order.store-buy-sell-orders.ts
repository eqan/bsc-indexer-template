...
import { extractAttributionData } from './utils.order';
        ...
        //   // Try to parse calldata as directPurchase
          ...
          try {
            ...
            if (callTrace) {
              ...
              start =
                side === OrderSide.buy ? orderLeft.start : orderRight.start;
              ...
              currencyPrice =
                side === OrderSide.buy ? newRightFill : newLeftFill;
