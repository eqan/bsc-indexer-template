...
export interface IQuery {
  GetAllCollections(
    filterCollectionDto: FilterDto,
  ): GetAllCollections | Promise<GetAllCollections>;
  ShowCollectionById(collectionId: string): Collections | Promise<Collections>;
  GetAllTokens(
    searchToken: FilterTokenDto,
  ): GetAllTokens | Promise<GetAllTokens>;
  ...
  ): GetAllOrders | Promise<GetAllOrders>;
}

export interface IMutation {
  CreateCollection(
    createCollection: CreateCollectionsInput,
  ...
  ): Nullable<Collections> | Promise<Nullable<Collections>>;
  ...
  ): Nullable<Tokens> | Promise<Nullable<Tokens>>;
